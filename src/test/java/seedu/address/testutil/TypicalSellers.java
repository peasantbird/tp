...
public class TypicalSellers {
    ...
    public static final Seller CARL = new SellerBuilder().withName("Carl Kurz").withPhone("95352563")
    ...
    public static final Seller DANIEL = new SellerBuilder().withName("Daniel Meier").withPhone("87652533")
    ...
    public static final Seller ELLE = new SellerBuilder().withName("Elle Meyer").withPhone("9482224")
    ...
    public static final Seller FIONA = new SellerBuilder().withName("Fiona Kunz").withPhone("9482427")
    ...
    public static final Seller GEORGE = new SellerBuilder().withName("George Best").withPhone("9482442")
    ...
    // Manually added
    public static final Seller HOON = new SellerBuilder().withName("Hoon Meier").withPhone("8482424")
